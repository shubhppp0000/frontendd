            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Table Bootstrap</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <table data-toggle="table" data-height="250" data-mobile-responsive="true" class="table-striped">
                                    ...
                                    <tbody>
                                        <tr id="tr-id-1" class="tr-class-1">
                                            <td id="td-id-1" class="td-class-1"> UTSAV VYAS </td>
                                            <td>480/500</td>
                                            <td>96%</td>
                                            <td>Passed with DISTINCTION </td>
                                        </tr>
                                        <tr id="tr-id-2" class="tr-class-2">
                                            <td id="td-id-2" class="td-class-2">SHUBHAM PRAJAPATI </td>
                                            <td>450/
                                            500</td>
                                            <td>90%</td>
                                            <td>Passed with DISTINCTION</td>
                                        ...
                                        <tr id="tr-id-3" class="tr-class-3">
                                            <td id="td-id-3" class="td-class-3"> NITESH MERCHANDE </td>
                                            <td>460/500</td>
                                            <td>92%</td>
                                            <td>PASSED with DISTINCTION</td>
                                        </tr>
                                        <tr id="tr-id-4" class="tr-class-4">
                                            <td id="td-id-4" class="td-class-4"> SAHIL PAWAR </td>
                                            <td>300/500</td>
                                            <td>60%</td>
                                            <td>PASSED with FIRSTCLASS</td>
                                        </tr>
                                        <tr id="tr-id-5" class="tr-class-5">
                                            <td id="td-id-5" class="td-class-5"> JAYESH JAIPAL
                                                <td>350/500</td>
                                                <td>70%</td>
                                                <td>PASSED with FIRSTCLASS</td>
                                ...
                                <a href="profile4.php" class="btn btn-success">submit</a>
                            </div>
                        </div>
