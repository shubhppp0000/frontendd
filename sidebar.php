            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="profile4.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Home </span></a>
                         ...
                         <li>
                            <a class="has-arrow waves-effect waves-dark" href="parent.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Parent </span></a>
                            <!--ul aria-expanded="false" class="collapse">
                                <li><a href="index.html">Dashboard 1</a></li>
                                <li><a href="index2.html">Dashboard 2</a></li>
                                <li><a href="index3.html">Dashboard 3</a></li>
                         ...
                         <li>
                            <a class="has-arrow waves-effect waves-dark" href="child.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Child </span></a>
                            <!--ul aria-expanded="false" class="collapse">
                                <li><a href="index.html">Dashboard 1</a></li>
                                <li><a href="index2.html">Dashboard 2</a></li>
                                <li><a href="index3.html">Dashboard 3</a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="School5.php" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">School</span></a>
                    </ul>
                </nav>
